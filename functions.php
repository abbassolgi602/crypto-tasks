...
// Count followers of projects
function count_followers_projects() {
	add_meta_box( 'followers_count', 'Followers', 'callback_followers', 'project' );
}
add_action( 'add_meta_boxes', 'count_followers_projects' );

function callback_followers() {
	if(get_post_meta( get_the_ID(), 'add_meta_boxes', true ) == '') {
		update_post_meta(get_the_ID(), 'add_meta_boxes', 0);
	}
	echo get_post_meta( get_the_ID(), 'add_meta_boxes', true );
}

// Show social media projects
